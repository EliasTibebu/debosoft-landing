...
import { LayoutGrid, ArrowLeft, Linkedin, Mail, Phone } from "lucide-react"
                  ...
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="space-y-2 text-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        With over 15 years of experience in software development and business leadership, Elias drives
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="space-y-2 text-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        A technology visionary with expertise in cloud architecture and AI, Ekram leads our technical
